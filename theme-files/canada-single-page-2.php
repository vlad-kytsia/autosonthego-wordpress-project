<?php
/* Template Name: Canada Template 2. Post Type: page */
get_header();
?>
...
<main id="primary" class="site-main page single-page-canada-2">	
	...
	<section class="canada-section-2">
		<div class="canada-section-2__container">
			<div class="canada-section-2__content">
			...
			<div class="canada-article__image">
				...
				if ( ! empty( $fields['section_2']['image_for_mobile'] ) ) : ?>
					<img src="<?php echo esc_url( $fields['section_2']['image_for_mobile'] ); ?>" class="canada-bg-mobile">
				<?php endif; ?>
				<div class="section-2-last-text">
					<?php 
					if ( ! empty( $fields['section_2']['last_text'] ) ) : ?>
						<?php echo wp_kses_post( $fields['section_2']['last_text'] ); ?>
					<?php endif; ?>
				</div>
			</div>
		</div>
			...
			<div class="canada-section-3__cards">
				...
				if ( (! empty( $cards )) && is_array( $cards ) ) {
					...
					<div class="canada-section-3__card">
						...
						<div class="canada-section-3__text-card animation_3" data-fls-watcher-threshold="0.15" data-fls-watcher-once data-fls-watcher>
							<?php 
							if ( ! empty( $card['text']  ) ) {
				...
				<div class="four-cards__card four-cards__card--3">
					<div class="wrapper-card">
						...
						<div class="content-card">
							...
							<div class="text-card animation_1" data-fls-watcher-threshold="0.15" data-fls-watcher-once data-fls-watcher>
								<?php
								if ( $card_3['text'] ) {
